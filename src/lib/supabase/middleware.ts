...
const PUBLIC_ROUTES = ['/', '/login', '/payment', '/auth/callback']
...
export async function updateSession(request: NextRequest) {
    ...
    // If logged in, check payment status for premium content routes
    const isPremiumRoute = pathname.startsWith('/roadmap') || pathname.startsWith('/learn')
